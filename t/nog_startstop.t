...
remake_td($td, $tdata);		# seq add1, oklz 1
...
remake_td($td, $tdata);		# seq add (default: add1)
...
remake_td($td, $tdata);		# seq (default: add1)
...
remake_td($td, $tdata);		# rand (default: add3)
...
remake_td($td, $tdata);		# type default: rand
$x = `$cmd mkminter zk2`;
