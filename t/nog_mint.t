...
{
remake_td($td, $tdata);		# rand stop with bad start
...
remake_td($td, $tdata);		# rand stop with status
...
remake_td($td, $tdata);		# rand99 add1
...
#remake_td($td, $tdata);		# seq start 5 add1
...
#
#remake_td($td, $tdata);		# seq start 135 add1
